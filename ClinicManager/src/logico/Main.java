...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Realizar consulta
		Consulta consulta1 = new Consulta(paciente1, medico1, fechaCita, "Dolor de pecho", "Angina de pecho", null);
		...
		Consulta consulta2 = new Consulta(paciente2, medico2, fechaCita, "Fiebre alta", "Dengue", dengue);
